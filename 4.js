...
class Drink {
  name="Чай";
  price=10;
  prepare(){console.log(`Приготування ${this.name}`)}// Метод prepare() виводить в консоль рядок "Приготування {назва напою}"
}
...
class HoneyDecorator {
  ...
  get name(){return `${this.drink.name} з ${this.amount} г меду`};
